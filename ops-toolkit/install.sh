...
# 2. 复制脚本到 scripts/ 【直接复制——路径改成你实际的文件位置】
cp ~/day每日/day46/扫描登录.sh	"${TOOLKIT_DIR}/scripts/ssh_monitor.sh"
cp ~/day每日/day48/html报表.sh	"${TOOLKIT_DIR}/scripts/nginx_report.sh"
cp ~/day每日/day49/系统资源巡检脚本.sh	"${TOOLKIT_DIR}/scripts/sys_monitor.sh"
